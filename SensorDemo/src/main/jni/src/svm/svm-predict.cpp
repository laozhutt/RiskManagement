...
int predict(float **values, int **indices, int rowNum, int colNum, int *labels, double *prob_estimates, int isProb, svm_model *model)
{
        ...
        int isProb, const char *modelFile, int *labels, double* prob_estimates, svm_model *model)
{
	...
	int r = predict(values, indices, rowNum, colNum, labels, prob_estimates, isProb, model);
